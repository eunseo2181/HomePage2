...
public class MemoDAO {
	...
	public List<MemoDTO> list(Map map) {
		...
		StringBuffer sql = new StringBuffer();
		sql.append(" select memono,title,grpno,indent,ansnum,wdate,viewcnt, r ");
		sql.append(" from ( ");
		sql.append(" 	select memono,title,grpno,indent,ansnum,wdate,viewcnt,rownum r ");
		sql.append(" 	from ( ");
		sql.append(" 		select memono,title,grpno,indent,ansnum, to_char(wdate,'yyyy-mm-dd') wdate, viewcnt ");
		sql.append(" 		from memo ");
	...
	public MemoDTO read(int memono) {
		...
		sql.append(" select memono, title, content, viewcnt, to_char(wdate,'yyyy-mm-dd') wdate ");
		sql.append(" from memo ");
		sql.append(" where memono = ? ");
	...
	public boolean create(MemoDTO dto) {
		...
		sql.append(" (memono, title, content, wdate, grpno) ");
	...
	public boolean createReply(MemoDTO dto) {
		...
		sql.append(" insert into memo ");
		sql.append(" (memono, title, content, wdate,grpno,indent, ansnum) ");
		sql.append(" values(memo_seq.nextval, ? , ?, sysdate, ");
		sql.append(" ?,?,? )  ");
